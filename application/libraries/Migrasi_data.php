    ...
    if($cek_izin)
    {
      ...
      if($cek_izin->kode == "DK" || $cek_izin->kode == "DL")
      {
        ...
        else
        {
          ...
          $keteranganTidakMasuk   = "";
          $jamKerja               = $cek_izin->kode;
          $keterangan             = $cek_izin->kode." DI HARI LIBUR, DAPAT LEMBUR 3 JAM (".$cek_izin->kode.")";
        }
      }
      else
      {
    ...
    else
    {
      ...
      if($cek_roster)
      {
        ...
        else
        {
          ...
          /*if(!$finger_masuk) {
            if (strtotime($finger_pulang) > strtotime($scanMulaiMasuk) && strtotime($finger_pulang) < strtotime($scanMulaiPulang)) {
              $finger_masuk = $finger_pulang;
            }
            else {
              $finger_pulang = false;
            }
          ...
          else
          {
            ...
            if($data_lembur){
              ...
              if(strtotime($finger_pulang) <  strtotime($date." ".$cek_roster->jam_akhir_scan_pulang) && strtotime($finger_pulang) > strtotime($date." ".$cek_roster->jam_pulang)){
                ...
                $menit_lembur          = $this->ambil_selisih_menit($date_pulang_rizky." ".$data_lembur->jam_lembur_awal, $date." ".$data_lembur->jam_lembur_akhir, $id_pegawai);
              ...
              else
              {
                ...
                //jika jam lembur lebih dari atau sama dengan 24 jam
                // if ($menit_lembur >= 1440)
                // {
                //     $menit_lembur = $menit_lembur - 1440;
                // }
            ...
            else
            {
              ...
              if(strtotime($date." ".$cek_roster->jam_pulang) > strtotime($finger_pulang))
              {
                $menit_lembur        = 0;
              }
              else
              {
                ...
                $menit_lembur        = $this->ambil_selisih_menit($date_pulang_rizky." ".$cek_roster->jam_pulang, $finger_pulang, 0);
              }
              $fingerMasuk           = $finger_masuk;
              if ($finger_masuk== '') {
                $menitTelat               = 480;
