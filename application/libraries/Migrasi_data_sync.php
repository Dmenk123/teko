<?php
class Migrasi_data_sync extends CI_Controller {
    protected $_ci;
  ...
  function dayOfWeek($date){
	...
	function cek_ulang_data_mentah($date, $id_pegawai, $fungsi){
		$keterangan 				    = "";
	   ...
	   if($cek_izin){
          if($cek_izin->kode == "DK" || $cek_izin->kode == "DL"){
            ...
            if($cek_hari_libur || $this->dayOfWeek($date) == 6 || $this->dayOfWeek($date) == 7){
                $menitPulangCepat 			= "0";
								$fingerMasuk				    =	"";
								$fingerPulang				    =	"";
								$menitTelat 				    = "0";
                ...
                if(strtotime($date) < strtotime('2018-07-01')){
                  ...
                  $jadwalPulang            = "";
								...
								$keterangan 				    =	$cek_izin->kode." DI HARI LIBUR, DAPAT LEMBUR 6 JAM";
            }
            else{
              $menitPulangCepat 			= "0";
              $fingerMasuk				    =	"";
              ...
              $keteranganTidakMasuk 	= "";
              $jamKerja 					    = $cek_izin->kode;
              $keterangan 				    =	$cek_izin->kode." DI HARI LIBUR, DAPAT LEMBUR 3 JAM";
          ...
          // var_dump($role_finger->jam_pulang);exit;
