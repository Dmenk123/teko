...
class Lap_skor_coba extends CI_Controller {
	...
	public function index(){
		...
		if($this->session->userdata('id_kategori_karyawan')=='4' || $this->session->userdata('id_kategori_karyawan')=='6' ){
			if ($this->session->userdata('kode_instansi') == '5.09.00.00.00') {
				//$whereInstansi =	"m_instansi.kode='5.09.00.00.00' or m_instansi.kode='5.09.00.91.00' or m_instansi.kode = '5.09.00.93.00'";
		...
		$this->template_view->load_view('laporan/lap_skor_coba_view');
