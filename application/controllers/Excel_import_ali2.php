...
class Excel_import_ali2 extends CI_Controller {
	...
	public function excel($param){
		...
		$file = './files/param_new/Puskesmas_jan-nov/FIX/'.$param.'';
		...
		foreach ($arr_data as $data) {
			...
			if ($pegawai == null) {
				...
				if($cek_insert){
					...
					if($cek_insert2){
						echo "data $no berhasil insert data mentah dan data mentah 2 <br/>";
					}
					else {
