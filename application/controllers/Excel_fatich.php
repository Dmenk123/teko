...
class Excel_fatich extends CI_Controller {
	...
	public function index(){
		...
		$file = './files/fatich_dishub/38_excel.xlsx';
		...
		foreach ($arr_data as $data) {
			...
			if ($pegawai == null) {
				...
				if($cek_insert){
					...
					if($cek_insert2){
						echo "data $no berhasil insert data mentah dan data mentah 2 $fingerMasuk $kodeMasuk $id_pegawai<br/>";
					}
					else {
