...
<div class="portlet box purple">
	...
	<div class="portlet-body">
		...
		?>
			<script>
				window.open('<?=base_url();?>cetak_new/lap_skor/?bulan=<?php echo $this->input->get("bulan"); ?>&tahun=<?php echo $this->input->get("tahun"); ?>&id_instansi=<?php echo $this->input->get("id_instansi"); ?>&pns=<?php echo $this->input->get("pns"); ?>')
			</script>
		<?php
		}
		?>
