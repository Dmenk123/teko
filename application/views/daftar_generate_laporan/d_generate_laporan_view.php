					...
					<form method="get">
						<div class="col-sm-4 col-md-offset-2">
							<select class="form-control" name="field">
								<option <?php if($this->input->get('field')=='nama_upd') echo "selected"; ?> value="nama_upd">Berdasarkan Nama</option>
		...
		<table class="table table-bordered">
			...
			?>
				<tr>
					...
					<td style="width:10%;">
						<select class="form-control" name="opsi_gen" onchange="opsiGen(this,'<?php echo $data->id_upd; ?>','<?php echo $data->nama_upd; ?>')">
                        ...
                        <div class="form-horizontal">
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <input type="input" class="form-control datePicker required" data-date-format='dd/mm/yyyy'  id="tgl_mulai"  name="tgl_mulai">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="input" class="form-control datePicker required" data-date-format='dd/mm/yyyy'  id="tgl_akhir" name="tgl_akhir">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="panel-body">
						<div class="form-horizontal">
                            ...
                            <div class="form-group">
									<label class="control-label col-sm-3" >Tanggal Mulai :</label>
                                <div class="col-sm-9">
                                    <input type="input" class="form-control datePicker required" data-date-format='dd/mm/yyyy'  id="tgl_mulai_peg"  name="tgl_mulai_peg">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
									<label class="control-label col-sm-3" >Tanggal Akhir :</label>
                                <div class="col-sm-9">
                                    <input type="input" class="form-control datePicker required" data-date-format='dd/mm/yyyy'  id="tgl_akhir_peg"  name="tgl_akhir_peg" onchange="enable_nama(this.value)">
                                </div>
                            </div>
                        ...
                        <div class="form-horizontal">
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <input type="input" class="form-control datePicker required" data-date-format='dd/mm/yyyy'  id="tgl_mulai_pns"  name="tgl_mulai">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
									<label class="control-label col-sm-3" >Tanggal Akhir :</label>
                                <div class="col-sm-9">
                                    <input type="input" class="form-control datePicker required" data-date-format='dd/mm/yyyy'  id="tgl_akhir_pns"  name="tgl_akhir">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-horizontal">
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <input type="input" class="form-control datePicker required" data-date-format='dd/mm/yyyy'  id="tgl_mulai_os"  name="tgl_mulai">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
									<label class="control-label col-sm-3" >Tanggal Akhir :</label>
                                <div class="col-sm-9">
                                    <input type="input" class="form-control datePicker required" data-date-format='dd/mm/yyyy'  id="tgl_akhir_os"  name="tgl_akhir">
                                </div>
                            </div>
                        </div>
                    </div>
...
/*function proses_generate() {
	...
	$('.hidden-msg').show();
	$.ajax({
		url:  base_url + 'cetak_new/lap_absensi_lembur/GeneratePerPegawaiManual',
		type: 'POST',
		dataType: 'json',
...
/*function proses_generate_os() {
	...
	$('.hidden-msg').show();
	$.ajax({
		url:  base_url + 'cetak_new/lap_absensi_lembur/MigrasiPerbagian_InsertManualOs',
		type: 'POST',
		dataType: 'json',
...
function proses_generate() {
	...
	$('#pesan_modal').modal('show');
	$.ajax({
		url:  base_url + 'cetak_new/lap_absensi_lembur/get_pegawai_garbos',
		type: 'POST',
		dataType: 'json',
		data: $('#form_generate_ins').serialize(),
		success: function(data){
...
function proses_generate_pns() {
	...
	$('#pesan_modal').modal('show');
	$.ajax({
		url:  base_url + 'cetak_new/lap_absensi_lembur/get_pegawai_garbos/pns',
		type: 'POST',
		dataType: 'json',
...
function proses_generate_os() {
	...
	$('#pesan_modal').modal('show');
	$.ajax({
		url:  base_url + 'cetak_new/lap_absensi_lembur/get_pegawai_garbos/os',
		type: 'POST',
		dataType: 'json',
		data: $('#form_generate_os').serialize(),
		success: function(data){
		...
		success: function(data){
			if (data.status == 'gagal') {
				...
				if(i < i_max){
					...
					$.ajax({
						url:  base_url + 'cetak_new/lap_absensi_lembur/update_selesai',
						type: 'POST',
						dataType: 'json',
						data: {
