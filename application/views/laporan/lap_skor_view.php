  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
				...
				?>
				<a href="<?= base_url('cetak_new/lap_skor2?bulan='.$bulan_get.'&tahun='.$tahun_get.'&id_instansi='.$id_instansi_get.'&pns='.$pns_get.'&lanjut_cetak=1') ?>" class="btn btn-danger">Lanjutkan Cetak</a>
