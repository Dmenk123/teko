												...
												<div class="col-md-12">
														<div class="btn-group">
																...
																<ul class="dropdown-menu" role="menu">
																		<li>
																				<a onClick="printPerInstansiSby('pdf')">Pdf </a>
																		</li>
																		<li>
																				<a onClick="printPerInstansiSby('xls')">Excel </a>
																		</li>
																		<li>
																				<a onClick="printPerInstansiSby('html')">Web </a>
																		</li>
																</ul>
														</div>
												</div>
...
<script>
	...
	function printPerInstansiSby(mode) {
		if((angka1 + angka2) == $("#angkaJawaban").val()) {
			if($("#kode_instansi").val() == '') {
				...
				if (date1 > date2) {
					...
					window.open('<?=base_url()?>cetak/cetakrekapinstansi?p=' + p, '_blank');
				}
			}
		}
		else {
