					...
					<!--	<td>
						...
						<td align=center>
							...
							if (!$data->kunci) {
								...
								echo $this->template_view->getEditButton(base_url()."lembur_pegawai/edit/?id_t_ijin=".$data->id_t_ijin."&redirect=".$url);
								?>
								&nbsp;
								<?php
...
$(document).ready(function() {
	...
	{
		$.ajax({
			url: base_url +'daftar_lembur_pegawai/cek_kunci_laporan',
			type:'GET',
			dataType:'json',
