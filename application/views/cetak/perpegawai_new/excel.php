...
<table border="0" width="100%" style="border-collapse: collapse;font-size:10px;">
  <thead style="font-size:12px;">
    <tr>
      <th align="center" colspan="14" style="font-size:13px;"><strong>PEMERINTAH KOTA SURABAYA<br/>LAPORAN PER PERIODE KEHADIRAN PEGAWAI</strong></th>
    </tr>
    <tr>
      <td colspan="4"></td>
      <td colspan="7" align="left"><?php echo  date('d-m-Y', strtotime($this->tgl_pertama));?> s/d <?php echo date('d-m-Y', strtotime($this->tgl_terakhir));?></td>
      <td rowspan="5" width="20%" class="barcodecell" colspan="3"><img src="<?=base_url()?>upload/qrcode/<?=$this->imageQrCode;?>" class="qr" height="80" /></td>
    </tr>
    <tr>
      <td>Nama</td>
      <td colspan="10"><?=$this->dataPegawai->nama;?></td>
    </tr>
    <tr>
      <td>Nip</td>
      <td colspan="10" align="left"><?=$this->dataPegawai->nip;?>&nbsp;</td>
    </tr>
    <tr>
      <td>Instansi</td>
      <td colspan="10"><?=$this->dataPegawai->nama_instansi;?></td>
    </tr>
    <tr>
      <td>Jabatan</td>
      <td colspan="10"><?=$this->dataPegawai->nama_jenis_jabatan;?></td>
    </tr>
    <tr>
      <td colspan="16"></td>
    </tr>
