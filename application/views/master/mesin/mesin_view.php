					...
					<form method="get">
						<div class="col-sm-6">
							<select class="form-control" name="field">
								<option <?php if($this->input->get('field')=='nama') echo "selected"; ?> value="nama">Berdasarkan Nama Mesin</option>
								<option <?php if($this->input->get('field')=='instansi') echo "selected"; ?> value="instansi">Berdasarkan Instansi</option>
							</select>
						</div>
						<div class="col-sm-6">
							<div class="input-group">
								<input type="text" class="form-control" name="keyword" 
									placeholder="Masukkan Kata Kunci" value="<?php echo $this->input->get('keyword'); ?>">
        ...
        <table class="table table-bordered table-hover table-striped">
            ...
            <tbody>
				...
				<tr>
					...
					<td ><?php echo $showData->jenis_mesin; ?></td>
					<td ><?php echo $showData->ip_address; ?></td>
					<td ><?php echo $showData->instansi; ?></td>
					<td ><?php echo $showData->area_mesin; ?></td>
