...
<div class="portlet box purple">
	...
	<div class="portlet-body">
		<form class="form-horizontal" id="form_standar" action="<?=base_url()."".$this->uri->segment(1)."/".$this->uri->segment(2);?>_data">
			...
			<div class="form-group">
				<label class="control-label col-sm-4" >Nama Status Pegawai :</label>
				<div class="col-sm-4">
					<input type="input" class="form-control required" id="NAMA"  name="NAMA" value="<?=$this->oldData->nama;?>">
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-sm-4" >Prosentasi :</label>
				<div class="col-sm-4">
					<input type="input" class="form-control" id="PROSENTASI"  name="PROSENTASI" value="<?=$this->oldData->prosentasi;?>">
				</div>
			</div>
