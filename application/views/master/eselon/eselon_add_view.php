	...
	<div class="portlet-body">
		<form class="form-horizontal" id="form_standar" action="<?=base_url()."".$this->uri->segment(1)."/".$this->uri->segment(2);?>_data">
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input type="input" class="form-control required" id="NAMA_ESELON"  name="NAMA_ESELON">
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-sm-4" >Tunjangan :</label>
				<div class="col-sm-4">
					<input type="number" min=0 step=0.1 class="form-control" id="TUNJANGAN"  name="TUNJANGAN">
				</div>
			</div>
			<!--<div class="form-group">
				<label class="control-label col-sm-4" >Kode Golongan Max :</label>
				<div class="col-sm-4">
					<input type="input" class="form-control" id="KODE_GOL_MAX"  name="KODE_GOL_MAX">
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-sm-4" >Kode Golongan Min :</label>
				<div class="col-sm-4">
					<input type="input" class="form-control" id="KODE_GOL_MIN"  name="KODE_GOL_MIN">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input type="input" class="form-control" id="URUT"  name="URUT">
				</div>
			</div>-->
