	...
	<div class="portlet-body">
		<form class="form-horizontal" id="form_standar" action="<?=base_url()."".$this->uri->segment(1)."/".$this->uri->segment(2);?>_data">
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input type="input" class="form-control required" id="DESKRIPSI"  name="DESKRIPSI" value="<?=$this->oldData->deskripsi;?>">
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-sm-4" >Kode Pangkat :</label>
				<div class="col-sm-4">
					<input type="input" class="form-control" id="KODE_PANGKAT"  name="KODE_PANGKAT" value="<?=$this->oldData->kode_pangkat;?>">
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-sm-4" >Kode Huruf :</label>
				<div class="col-sm-4">
					<input type="input" class="form-control required" id="KODE_HURUF"  name="KODE_HURUF" value="<?=$this->oldData->kode_huruf;?>">
				</div>
			</div>
