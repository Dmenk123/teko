	...
	<div class="portlet-body">
				...
				<div class="col-md-12">
					<div class="col-md-6">
						<div class="form-group row">
							...
							<div class="col-md-8">
								<input type="text" value="<?=$this->input->get('tgl_mulai');?>" class="form-control" required id="tgl_mulai"  name="tgl_mulai" onChange="cekPegawai()" autocomplete="off">
							</div>
						</div>
					</div>
					<div class="col-md-6">
						<div class="form-group row">
							...
							<div class="col-md-8">
								<input type="text" value="<?=$this->input->get('tgl_akhir');?>" class="form-control" required id="tgl_akhir"  name="tgl_akhir" onChange="cekPegawai()" autocomplete="off">
							</div>
						</div>
					</div>
				</div>
						...
						<div class="form-group row">
							...
							<div class="col-md-10">
								<select class="form-control select2" required id="id_instansi" name="id_instansi">
									...
									<?php if($this->input->get('id_instansi') == $value->kode) echo "selected";?>>
										<?= $value->nama ?>
									</option>
									<?php } ?>
								</select>
		...
		<?php if($this->input->get('tgl_mulai') and $this->input->get('tgl_akhir') and $this->input->get('id_instansi')) { ?>
		<table class="table table-striped table-bordered table-hover">
			...
			<tbody>
				<?php foreach ($log_unor as $key => $value) { ?>
				<tr>
					<td><?= ($key+1) ?></td>
...
<script>
	$(function () {
		...
		$('#id_instansi').change(function () {
			...
			$.ajax({
				url: "<?= base_url('log_absen_per_unor/get_pegawai_by_instansi') ?>" + '/' + $(this).val(),
