...
class Golongan_model extends CI_Model {
	...
	function showData($where = null,$like = null,$order_by = null,$limit = null,$fromLimit = null,$or_where = null,$or_like = null){
		...
		return $this->db->get("m_golongan",$limit,$fromLimit)->result();
	}
	...
	function getCount($where = null,$like = null,$order_by = null,$limit = null,$fromLimit = null,$or_where = null,$or_like = null){
		...
		return $this->db->get("m_golongan",$limit,$fromLimit)->num_rows();
	}

	function getData($where){
		$this->db->select("*");
		$this->db->where($where);
		return $this->db->get("m_golongan")->row();
	}


	function getPrimaryKeyMax(){
		$query = $this->db->query('select max(kode) as MAX from m_golongan') ;
		return $query->row();
	}
	...
	function update($where,$data){
		$this->db->where($where);
		$this->db->update('m_golongan', $data);
	}
	function delete($where){
		$this->db->where($where);
		$this->db->delete('m_golongan');
	}
}
