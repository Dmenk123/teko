...
class Agama_model extends CI_Model {
	...
	function showData($where = null,$like = null,$order_by = null,$limit = null, $fromLimit=null){
		...
		return $this->db->get("m_agama",$limit,$fromLimit)->result();
	}
	...
	function getCount($where = null,$like = null,$order_by = null,$limit = null, $fromLimit=null){
		...
		return $this->db->get("m_agama",$limit,$fromLimit)->num_rows();
	}
	...
	function getPrimaryKeyMax(){
		$query = $this->db->query('select max(kode) as MAX from m_agama') ;
		return $query->row();
	}
