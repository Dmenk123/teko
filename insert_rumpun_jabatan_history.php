...
$connection = pg_connect($conn_string);
 $queryPegawai	=	"
  select id,kode_rumpun_jabatan from m_pegawai where id not in (select id_pegawai from m_pegawai_rumpun_jabatan_histori)
";
...
while ($rowPegawai 	= pg_fetch_assoc($resultInstansi)) {
  ...
  echo $queryInsert	=	"
    insert into m_pegawai_rumpun_jabatan_histori
    (
      id,
      tgl_mulai,
      tgl_upd,
